...
parser.add_argument('--src_dir', dest='src_dir', default='./dataset/test', help='dir of data')
parser.add_argument('--save_dir', dest='save_dir', default='./dataset', help='dir of patches')
...
parser.add_argument('--from_file', dest='from_file', default="./dataset/test/*.jpg", help='get pic from file')
